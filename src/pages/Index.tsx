      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-card/80 backdrop-blur-xl border-b border-border">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-xl">YTJ Shop Manager</span>
          </div>
          <div className="flex items-center gap-3">
          ...
          <div className="bg-card rounded-3xl p-8 md:p-16 text-center relative overflow-hidden shadow-xl">
            ...
            <div className="relative z-10">
              ...
              <p className="text-muted-foreground max-w-xl mx-auto mb-8">
                Join hundreds of businesses already using YTJ Shop Manager to streamline their operations.
              </p>
      ...
      <footer className="py-8 px-4 border-t border-border">
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold">YTJ Shop Manager</span>
          </div>
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} YTJShopManager. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
